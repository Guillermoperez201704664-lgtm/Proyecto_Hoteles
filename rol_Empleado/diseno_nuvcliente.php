   ...
   <form id="frmncliente" method="post">
        <div class="form-row">
           <div class="form-group col-md-2">
             ...
             <input type="num" class="form-control" name="txtid" id="txtid">
           </div>
        ...
        <div class="form-row">
           <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control" name="txtdpi" >
           </div>
           <div class="form-group col-md-5">
              <label for="txt_sexo">Sexo (1-M o 2-F)</label><br>
              <select name="txtsexo" class="form-group col-md-3" id="txtdpi">
                <?php
                   include "conexion.php";
                   $sql = "select * from sexo";
                   $ejecutar = mysqli_query($conexion, $sql);
                   while($sexo = mysqli_fetch_array($ejecutar)){
                    echo "<option value='".$sexo['sexo_id']."'>".utf8_encode($sexo['sexo_id'])."</option>";
                  } 
                ?>
              </select>
           </div>
